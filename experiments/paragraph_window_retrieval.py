...
def default_retriever(query):
    ...
    context = [paragraph for i in indices[0] for paragraph in paragraphs if sentences[i] in paragraph]
...
if __name__ == "__main__":
    ...
    paragraphs = [paragraph for paragraphs in text_df['paragraphs'].to_list() for paragraph in paragraphs ]
